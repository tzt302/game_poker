...
- 过牌、跟注、加注、全下、弃牌
- 牌型比较、平分底池及边池结算
- 具有景深、厚度和透视光影的 2.5D 牌桌
- 逐张发牌、公共牌翻转、筹码飞行、弃牌与派奖动画
- AI 行动气泡、完整牌局动态时间线和当前行动者说明
- 四种可辨识的 AI 性格：谨慎猎手、强势施压、冷静计算、松凶玩家
- 最小、半池、3/4 池、满池、全下快捷下注与精确非线性滑杆
- 更自然的 AI 思考停顿、可缩放窗口和键鼠快捷操作
